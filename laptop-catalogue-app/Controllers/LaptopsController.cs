...
namespace PROG2231_Assignment2__9031031_.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LaptopId,Model,Brand,Year")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LaptopId,Model,Brand,Year")] Laptop laptop)
        {
